...
- **Ambient "Live" theme** _(opt-in)_ — mirrors your real local time of day and weather: light sunny palettes through dawn/day/afternoon, dark by dusk/night, with sun/moon, rain, snow, fog and storm effects, powered by geolocation + the key-less Open-Meteo API. A settings popover lets you **manually override** the time and weather too
